...
function SearchProduct() {
    ...
    const searchdata = async (title) => {
        ...
        await axios.get(`${baseURL}/property/search/${title}`).then((resu, err) => {
            ...
            <div className="container">
                <div className="row ">
                    ...
                    <div className="text-center col-md-6 col-sm-12 col-lg-6  mt-5">
                        ...
                        <input class="form-control" list="datalistOptions" id="exampleDataList" type="text" value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Enter a Search Item" />
                        <button onClick={() => (searchdata(title))} className="btn btn-success mt-3">Search</button>
